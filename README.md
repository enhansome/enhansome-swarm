...
* [Docker Compose V3 File Format Docs](https://github.com/docker/compose/blob/v1/docs/Compose%20file%20reference%20\(legacy\)/version-3.md) ⭐ 38,084 | 🐛 95 | 🌐 Go | 📅 2026-08-13 - Documentation for the Docker Compose V3 format that the `docker stack` command uses.
...
* [Heckenmann Swarm Dashboard](https://github.com/heckenmann/docker-swarm-dashboard) ⭐ 50 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-13 - A Monitoring Dashboard for a Docker Swarm Cluster that gives you a bit more insights.
...
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,313 | 🐛 188 | 🌐 Go | 📅 2026-08-13 - JuiceFS is a distributed POSIX file system built on top of S3. It has a maintained [Docker plugin](https://github.com/juicedata/docker-volume-juicefs) ⭐ 45 | 🐛 15 | 🌐 Go | 📅 2026-05-08.
* [Ceph](https://ceph.io/) - Ceph is a distributed object, block, and file storage platform. **Do you want Ceph CSI support? [Upvote this issue](https://github.com/ceph/ceph-csi/issues/3769) ⭐ 1,566 | 🐛 131 | 🌐 Go | 📅 2026-08-13**
...
* [Hetzner Cloud Volume CSI Driver](https://github.com/hetznercloud/csi-driver) ⭐ 793 | 🐛 22 | 🌐 Go | 📅 2026-08-12 - Hetzner Cloud Volume CSI Driver with experimental support for Docker Swarm.
...
* [Traefik Proxy](https://github.com/traefik/traefik) ⭐ 64,453 | 🐛 892 | 🌐 Go | 📅 2026-08-13 - A reverse proxy and load balancer that makes deploying HTTP (and more) published services easy. Swarm Mode docs [start here](https://doc.traefik.io/traefik/providers/docker/#docker-swarm-mode).
* [Caddy Docker Proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,616 | 🐛 46 | 🌐 Go | 📅 2026-07-27 - Caddy based reverse proxy with automatic service discovery based on labels.
...
* [awesome-compose](https://github.com/docker/awesome-compose) ⭐ 46,080 | 🐛 414 | 🌐 HTML | 📅 2026-08-11 - A list of awesome Docker Compose samples.
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,631 | 🐛 24 | 📅 2026-07-29 - A list of awesome Docker tools.

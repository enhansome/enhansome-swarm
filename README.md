...
* [Docker Compose V3 File Format Docs](https://github.com/docker/compose/blob/v1/docs/Compose%20file%20reference%20\(legacy\)/version-3.md) ⭐ 38,049 | 🐛 94 | 🌐 Go | 📅 2026-08-20 - Documentation for the Docker Compose V3 format that the `docker stack` command uses.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,626 | 🐛 15 | 🌐 Go | 📅 2026-08-20 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
...
* [Gantry](https://github.com/shizunge/gantry) ⭐ 90 | 🐛 0 | 🌐 Shell | 📅 2026-08-20 - a tool to update docker swarm services, enhanced [Shepherd](https://github.com/djmaze/shepherd) ⭐ 592 | 🐛 13 | 🌐 Shell | 📅 2025-11-11.
...
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,346 | 🐛 200 | 🌐 Go | 📅 2026-08-20 - JuiceFS is a distributed POSIX file system built on top of S3. It has a maintained [Docker plugin](https://github.com/juicedata/docker-volume-juicefs) ⭐ 45 | 🐛 14 | 🌐 Go | 📅 2026-08-17.
* [Ceph](https://ceph.io/) - Ceph is a distributed object, block, and file storage platform. **Do you want Ceph CSI support? [Upvote this issue](https://github.com/ceph/ceph-csi/issues/3769) ⭐ 1,568 | 🐛 139 | 🌐 Go | 📅 2026-08-20**
* [NetApp Trident](https://github.com/NetApp/trident) ⭐ 873 | 🐛 274 | 🌐 Go | 📅 2026-08-19 - A NetApp storage driver that has been known to work with Docker Engine and Swarm in the past. CSI Swarm support [has been requested](https://github.com/NetApp/trident/issues/804) ⭐ 873 | 🐛 274 | 🌐 Go | 📅 2026-08-19.
* [Hetzner Cloud Volume CSI Driver](https://github.com/hetznercloud/csi-driver) ⭐ 794 | 🐛 22 | 🌐 Go | 📅 2026-08-20 - Hetzner Cloud Volume CSI Driver with experimental support for Docker Swarm.
...
* [Traefik Proxy](https://github.com/traefik/traefik) ⭐ 64,521 | 🐛 905 | 🌐 Go | 📅 2026-08-20 - A reverse proxy and load balancer that makes deploying HTTP (and more) published services easy. Swarm Mode docs [start here](https://doc.traefik.io/traefik/providers/docker/#docker-swarm-mode).
* [Caddy Docker Proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,622 | 🐛 47 | 🌐 Go | 📅 2026-08-20 - Caddy based reverse proxy with automatic service discovery based on labels.
...
* [awesome-compose](https://github.com/docker/awesome-compose) ⭐ 46,134 | 🐛 414 | 🌐 HTML | 📅 2026-08-15 - A list of awesome Docker Compose samples.
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,674 | 🐛 14 | 📅 2026-08-19 - A list of awesome Docker tools.

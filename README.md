...
* [Docker Compose V3 File Format Docs](https://github.com/docker/compose/blob/v1/docs/Compose%20file%20reference%20\(legacy\)/version-3.md) ⭐ 38,200 | 🐛 108 | 🌐 Go | 📅 2026-09-21 - Documentation for the Docker Compose V3 format that the `docker stack` command uses.
* [SwarmKit Repository](https://github.com/moby/swarmkit) ⭐ 3,652 | 🐛 275 | 🌐 Go | 📅 2026-09-17 - The upstream project that provides Swarm features to a container runtime.
...
* [Dockersamples Swarm Visualizer](https://github.com/dockersamples/docker-swarm-visualizer) ⭐ 3,339 | 🐛 11 | 🌐 JavaScript | 📅 2024-10-26 - A basic web GUI visualizing a Swarm cluster. More of a concept and teaching UI than a production tool.
* [Swirl](https://github.com/cuigh/swirl) ⭐ 667 | 🐛 23 | 🌐 Go | 📅 2023-05-16 - Web UI for Docker, focused on swarm cluster.
* [Mohsenasm Swarm Dashboard](https://github.com/mohsenasm/swarm-dashboard) ⭐ 239 | 🐛 11 | 🌐 Elm | 📅 2026-09-14 - A Simple Monitoring Dashboard for Docker Swarm Cluster.
...
* [Heckenmann Swarm Dashboard](https://github.com/heckenmann/docker-swarm-dashboard) ⭐ 50 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-21 - A Monitoring Dashboard for a Docker Swarm Cluster that gives you a bit more insights.
* [AWS Docker Swarm Terraform Module](https://github.com/trajano/terraform-docker-swarm-aws) ⭐ 47 | 🐛 4 | 🌐 HCL | 📅 2026-09-09
* [swarmcli](https://github.com/Eldara-Tech/swarmcli) ⭐ 21 | 🐛 20 | 🌐 Go | 📅 2026-09-20 - Swarm Management at the speed of thought — with real-time log streaming, instant shell access to containers, seamless port forwarding, and on-demand secret reveal capabilities, giving you full control over your Docker Swarm without breaking your flow.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,670 | 🐛 16 | 🌐 Go | 📅 2026-09-21 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
* [Swarm Cronjob](https://github.com/crazy-max/swarm-cronjob) ⭐ 884 | 🐛 40 | 🌐 Go | 📅 2026-09-17 - By [@crazy-max](https://github.com/crazy-max). Create jobs on a time-based schedule.
* [Shepherd](https://github.com/djmaze/shepherd) ⭐ 595 | 🐛 15 | 🌐 Shell | 📅 2025-11-11 - Automatically update services whenever their image is refreshed.
* [SwarmCD](https://github.com/m-adawi/swarm-cd) ⭐ 193 | 🐛 41 | 🌐 Go | 📅 2026-05-20 - Declarative GitOps and Continuous Deployment tool for Swarm.
...
* [Gantry](https://github.com/shizunge/gantry) ⭐ 90 | 🐛 0 | 🌐 Shell | 📅 2026-09-21 - a tool to update docker swarm services, enhanced [Shepherd](https://github.com/djmaze/shepherd) ⭐ 595 | 🐛 15 | 🌐 Shell | 📅 2025-11-11.
...
* [Swarmhook](https://github.com/M4TY/swarmhook) ⭐ 8 | 🐛 0 | 🌐 TypeScript | 📅 2025-09-03 - A simple to use service that redeploys Swarm services using webhooks.
...
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,448 | 🐛 209 | 🌐 Go | 📅 2026-09-21 - JuiceFS is a distributed POSIX file system built on top of S3. It has a maintained [Docker plugin](https://github.com/juicedata/docker-volume-juicefs) ⭐ 45 | 🐛 14 | 🌐 Go | 📅 2026-08-17.
* [Ceph](https://ceph.io/) - Ceph is a distributed object, block, and file storage platform. **Do you want Ceph CSI support? [Upvote this issue](https://github.com/ceph/ceph-csi/issues/3769) ⭐ 1,576 | 🐛 140 | 🌐 Go | 📅 2026-09-21**
* [NetApp Trident](https://github.com/NetApp/trident) ⭐ 878 | 🐛 286 | 🌐 Go | 📅 2026-09-15 - A NetApp storage driver that has been known to work with Docker Engine and Swarm in the past. CSI Swarm support [has been requested](https://github.com/NetApp/trident/issues/804) ⭐ 878 | 🐛 286 | 🌐 Go | 📅 2026-09-15.
* [Hetzner Cloud Volume CSI Driver](https://github.com/hetznercloud/csi-driver) ⭐ 798 | 🐛 28 | 🌐 Go | 📅 2026-09-21 - Hetzner Cloud Volume CSI Driver with experimental support for Docker Swarm.
* [Hetzner Cloud Docker Volume Plugin](https://github.com/costela/docker-volume-hetzner) ⭐ 119 | 🐛 8 | 🌐 Go | 📅 2026-09-21 - Unofficial volume driver for [Hetzner Cloud](https://www.hetzner.com/cloud) by [@costela](https://github.com/costela).
...
* [Traefik Proxy](https://github.com/traefik/traefik) ⭐ 64,920 | 🐛 939 | 🌐 Go | 📅 2026-09-21 - A reverse proxy and load balancer that makes deploying HTTP (and more) published services easy. Swarm Mode docs [start here](https://doc.traefik.io/traefik/providers/docker/#docker-swarm-mode).
* [Caddy Docker Proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,665 | 🐛 50 | 🌐 Go | 📅 2026-09-21 - Caddy based reverse proxy with automatic service discovery based on labels.
...
* [promswarm](https://github.com/neuroforgede/promswarm) ⭐ 33 | 🐛 1 | 🌐 Jinja | 📅 2024-04-06 - Modernized version of [Swarmprom](https://github.com/stefanprodan/swarmprom) ⚠️ Archived, a great Prometheus/Grafana stack originally by [@stefanprodan](https://github.com/stefanprodan), now maintained by [@neuroforgede](https://github.com/neuroforgede).
...
* [Swarm vs. Compose for Production](https://github.com/BretFisher/ama/discussions/146) ⭐ 363 | 🐛 0 | 📅 2021-08-23 - Only one host for a production environment. What to use: docker-compose or single node swarm?
...
* [awesome-compose](https://github.com/docker/awesome-compose) ⭐ 46,386 | 🐛 431 | 🌐 HTML | 📅 2026-09-19 - A list of awesome Docker Compose samples.
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,865 | 🐛 37 | 📅 2026-09-12 - A list of awesome Docker tools.
...
* [RexRay](https://github.com/rexray/rexray) ⭐ 2,221 | 🐛 294 | 🌐 Go | 📅 2023-09-02 - A container storage orchestration engine.
...
Want to contribute? Please read the [contribution guidelines](contributing.md). You can also ask questions in the [GitHub Discussions](https://github.com/BretFisher/awesome-swarm/discussions) ⭐ 749 | 🐛 7 | 📅 2026-08-19, or our [Discord Server #swarm channel](https://discord.gg/4jPPynEb2e).

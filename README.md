...
* [Docker Compose V3 File Format Docs](https://github.com/docker/compose/blob/v1/docs/Compose%20file%20reference%20\(legacy\)/version-3.md) ⭐ 38,117 | 🐛 116 | 🌐 Go | 📅 2026-09-04 - Documentation for the Docker Compose V3 format that the `docker stack` command uses.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,648 | 🐛 10 | 🌐 Go | 📅 2026-09-05 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
...
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,396 | 🐛 216 | 🌐 Go | 📅 2026-09-04 - JuiceFS is a distributed POSIX file system built on top of S3. It has a maintained [Docker plugin](https://github.com/juicedata/docker-volume-juicefs) ⭐ 45 | 🐛 14 | 🌐 Go | 📅 2026-08-17.
* [Ceph](https://ceph.io/) - Ceph is a distributed object, block, and file storage platform. **Do you want Ceph CSI support? [Upvote this issue](https://github.com/ceph/ceph-csi/issues/3769) ⭐ 1,574 | 🐛 155 | 🌐 Go | 📅 2026-09-04**
...
* [Hetzner Cloud Volume CSI Driver](https://github.com/hetznercloud/csi-driver) ⭐ 795 | 🐛 22 | 🌐 Go | 📅 2026-09-04 - Hetzner Cloud Volume CSI Driver with experimental support for Docker Swarm.
...
* [Traefik Proxy](https://github.com/traefik/traefik) ⭐ 64,752 | 🐛 905 | 🌐 Go | 📅 2026-09-04 - A reverse proxy and load balancer that makes deploying HTTP (and more) published services easy. Swarm Mode docs [start here](https://doc.traefik.io/traefik/providers/docker/#docker-swarm-mode).
* [Caddy Docker Proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,638 | 🐛 49 | 🌐 Go | 📅 2026-08-20 - Caddy based reverse proxy with automatic service discovery based on labels.
...
* [awesome-compose](https://github.com/docker/awesome-compose) ⭐ 46,237 | 🐛 423 | 🌐 HTML | 📅 2026-09-04 - A list of awesome Docker Compose samples.
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,785 | 🐛 30 | 📅 2026-08-27 - A list of awesome Docker tools.

...
* [Docker Compose V3 File Format Docs](https://github.com/docker/compose/blob/v1/docs/Compose%20file%20reference%20\(legacy\)/version-3.md) ⭐ 38,075 | 🐛 109 | 🌐 Go | 📅 2026-08-28 - Documentation for the Docker Compose V3 format that the `docker stack` command uses.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,643 | 🐛 13 | 🌐 Go | 📅 2026-08-29 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
...
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,371 | 🐛 199 | 🌐 Go | 📅 2026-08-28 - JuiceFS is a distributed POSIX file system built on top of S3. It has a maintained [Docker plugin](https://github.com/juicedata/docker-volume-juicefs) ⭐ 45 | 🐛 14 | 🌐 Go | 📅 2026-08-17.
...
* [Traefik Proxy](https://github.com/traefik/traefik) ⭐ 64,656 | 🐛 913 | 🌐 Go | 📅 2026-08-28 - A reverse proxy and load balancer that makes deploying HTTP (and more) published services easy. Swarm Mode docs [start here](https://doc.traefik.io/traefik/providers/docker/#docker-swarm-mode).
* [Caddy Docker Proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,633 | 🐛 49 | 🌐 Go | 📅 2026-08-20 - Caddy based reverse proxy with automatic service discovery based on labels.
...
* [awesome-compose](https://github.com/docker/awesome-compose) ⭐ 46,195 | 🐛 417 | 🌐 HTML | 📅 2026-08-25 - A list of awesome Docker Compose samples.
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,745 | 🐛 27 | 📅 2026-08-27 - A list of awesome Docker tools.

...
* [Docker Compose V3 File Format Docs](https://github.com/docker/compose/blob/v1/docs/Compose%20file%20reference%20\(legacy\)/version-3.md) ⭐ 38,072 | 🐛 108 | 🌐 Go | 📅 2026-08-28 - Documentation for the Docker Compose V3 format that the `docker stack` command uses.
* [SwarmKit Repository](https://github.com/moby/swarmkit) ⭐ 3,647 | 🐛 276 | 🌐 Go | 📅 2026-08-28 - The upstream project that provides Swarm features to a container runtime.
...
* [Heckenmann Swarm Dashboard](https://github.com/heckenmann/docker-swarm-dashboard) ⭐ 50 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-28 - A Monitoring Dashboard for a Docker Swarm Cluster that gives you a bit more insights.
* [AWS Docker Swarm Terraform Module](https://github.com/trajano/terraform-docker-swarm-aws) ⭐ 47 | 🐛 4 | 🌐 HCL | 📅 2025-10-23
* [swarmcli](https://github.com/Eldara-Tech/swarmcli) ⭐ 20 | 🐛 15 | 🌐 Go | 📅 2026-08-28 - Swarm Management at the speed of thought — with real-time log streaming, instant shell access to containers, seamless port forwarding, and on-demand secret reveal capabilities, giving you full control over your Docker Swarm without breaking your flow.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,642 | 🐛 16 | 🌐 Go | 📅 2026-08-29 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
...
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,367 | 🐛 197 | 🌐 Go | 📅 2026-08-28 - JuiceFS is a distributed POSIX file system built on top of S3. It has a maintained [Docker plugin](https://github.com/juicedata/docker-volume-juicefs) ⭐ 45 | 🐛 14 | 🌐 Go | 📅 2026-08-17.
* [Ceph](https://ceph.io/) - Ceph is a distributed object, block, and file storage platform. **Do you want Ceph CSI support? [Upvote this issue](https://github.com/ceph/ceph-csi/issues/3769) ⭐ 1,569 | 🐛 149 | 🌐 Go | 📅 2026-08-27**
...
* [Traefik Proxy](https://github.com/traefik/traefik) ⭐ 64,639 | 🐛 914 | 🌐 Go | 📅 2026-08-28 - A reverse proxy and load balancer that makes deploying HTTP (and more) published services easy. Swarm Mode docs [start here](https://doc.traefik.io/traefik/providers/docker/#docker-swarm-mode).
* [Caddy Docker Proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,631 | 🐛 49 | 🌐 Go | 📅 2026-08-20 - Caddy based reverse proxy with automatic service discovery based on labels.
...
* [awesome-compose](https://github.com/docker/awesome-compose) ⭐ 46,189 | 🐛 417 | 🌐 HTML | 📅 2026-08-25 - A list of awesome Docker Compose samples.
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,736 | 🐛 25 | 📅 2026-08-27 - A list of awesome Docker tools.

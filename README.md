...
* [Docker Compose V3 File Format Docs](https://github.com/docker/compose/blob/v1/docs/Compose%20file%20reference%20\(legacy\)/version-3.md) ⭐ 38,126 | 🐛 110 | 🌐 Go | 📅 2026-09-07 - Documentation for the Docker Compose V3 format that the `docker stack` command uses.
* [SwarmKit Repository](https://github.com/moby/swarmkit) ⭐ 3,649 | 🐛 276 | 🌐 Go | 📅 2026-08-28 - The upstream project that provides Swarm features to a container runtime.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,649 | 🐛 13 | 🌐 Go | 📅 2026-09-07 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
...
* [SwarmCD](https://github.com/m-adawi/swarm-cd) ⭐ 189 | 🐛 41 | 🌐 Go | 📅 2026-05-20 - Declarative GitOps and Continuous Deployment tool for Swarm.
...
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,400 | 🐛 212 | 🌐 Go | 📅 2026-09-07 - JuiceFS is a distributed POSIX file system built on top of S3. It has a maintained [Docker plugin](https://github.com/juicedata/docker-volume-juicefs) ⭐ 45 | 🐛 14 | 🌐 Go | 📅 2026-08-17.
* [Ceph](https://ceph.io/) - Ceph is a distributed object, block, and file storage platform. **Do you want Ceph CSI support? [Upvote this issue](https://github.com/ceph/ceph-csi/issues/3769) ⭐ 1,574 | 🐛 152 | 🌐 Go | 📅 2026-09-07**
* [NetApp Trident](https://github.com/NetApp/trident) ⭐ 876 | 🐛 281 | 🌐 Go | 📅 2026-08-27 - A NetApp storage driver that has been known to work with Docker Engine and Swarm in the past. CSI Swarm support [has been requested](https://github.com/NetApp/trident/issues/804) ⭐ 876 | 🐛 281 | 🌐 Go | 📅 2026-08-27.
* [Hetzner Cloud Volume CSI Driver](https://github.com/hetznercloud/csi-driver) ⭐ 795 | 🐛 23 | 🌐 Go | 📅 2026-09-07 - Hetzner Cloud Volume CSI Driver with experimental support for Docker Swarm.
...
* [Traefik Proxy](https://github.com/traefik/traefik) ⭐ 64,781 | 🐛 918 | 🌐 Go | 📅 2026-09-07 - A reverse proxy and load balancer that makes deploying HTTP (and more) published services easy. Swarm Mode docs [start here](https://doc.traefik.io/traefik/providers/docker/#docker-swarm-mode).
* [Caddy Docker Proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,639 | 🐛 50 | 🌐 Go | 📅 2026-09-07 - Caddy based reverse proxy with automatic service discovery based on labels.
...
* [awesome-compose](https://github.com/docker/awesome-compose) ⭐ 46,259 | 🐛 424 | 🌐 HTML | 📅 2026-09-04 - A list of awesome Docker Compose samples.
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,799 | 🐛 30 | 📅 2026-08-27 - A list of awesome Docker tools.

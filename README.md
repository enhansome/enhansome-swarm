...
* [Docker Compose V3 File Format Docs](https://github.com/docker/compose/blob/v1/docs/Compose%20file%20reference%20\(legacy\)/version-3.md) ⭐ 38,147 | 🐛 112 | 🌐 Go | 📅 2026-09-11 - Documentation for the Docker Compose V3 format that the `docker stack` command uses.
...
* [doco-cd](https://github.com/kimdre/doco-cd) ⭐ 1,660 | 🐛 15 | 🌐 Go | 📅 2026-09-13 - Lightweight GitOps and Continuous Deployment tool to deploy Docker Compose projects and Swarm stacks using polling and webhooks.
...
* [juicefs](https://github.com/juicedata/juicefs) ⭐ 14,420 | 🐛 208 | 🌐 Go | 📅 2026-09-10 - JuiceFS is a distributed POSIX file system built on top of S3. It has a maintained [Docker plugin](https://github.com/juicedata/docker-volume-juicefs) ⭐ 45 | 🐛 14 | 🌐 Go | 📅 2026-08-17.
* [Ceph](https://ceph.io/) - Ceph is a distributed object, block, and file storage platform. **Do you want Ceph CSI support? [Upvote this issue](https://github.com/ceph/ceph-csi/issues/3769) ⭐ 1,574 | 🐛 140 | 🌐 Go | 📅 2026-09-11**
...
* [Traefik Proxy](https://github.com/traefik/traefik) ⭐ 64,830 | 🐛 924 | 🌐 Go | 📅 2026-09-11 - A reverse proxy and load balancer that makes deploying HTTP (and more) published services easy. Swarm Mode docs [start here](https://doc.traefik.io/traefik/providers/docker/#docker-swarm-mode).
* [Caddy Docker Proxy](https://github.com/lucaslorentz/caddy-docker-proxy) ⭐ 4,646 | 🐛 50 | 🌐 Go | 📅 2026-09-07 - Caddy based reverse proxy with automatic service discovery based on labels.
* [Libnetwork Troubleshooting](https://github.com/moby/libnetwork/blob/master/cmd/diagnostic/README.md) ⭐ 2,205 | 🐛 207 | 🌐 Go | 📅 2023-10-20 - Official Doc on using network diagnostic tools.
...
* [awesome-compose](https://github.com/docker/awesome-compose) ⭐ 46,305 | 🐛 428 | 🌐 HTML | 📅 2026-09-11 - A list of awesome Docker Compose samples.
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,816 | 🐛 32 | 📅 2026-09-12 - A list of awesome Docker tools.
